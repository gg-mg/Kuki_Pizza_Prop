...
function Pizza(pizzaSize, crust) {
  ...
  var createPizza = function() {
    ...
    var crust = $('input[name="crust-options"]:checked').val();
  ...
  var resetPizzaForm = function() {
    $('input[name="pie-size"]:checked').prop("checked", false);
    $('input[value="medium"]').prop("checked", false);
    $('input[name="crust-options"]:checked').attr("checked", false);
    $('input[value="stuffed"]').prop("checked", true);
  ...
  var populatePizzaList = function(pizza) {
    $('.pizza-list').append('<div class="pizza">' +
                              ...
                              '<div class="pizza-info-toggle">' +
                                '<p>Crust: <span class="pizza-list-crust">'+pizza.crust+'</span></p>' +
                                '<p>Meat toppings: </p>' +
